            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  ...
                  <span className={`text-xs font-semibold px-3 py-1 rounded-full flex-shrink-0 ${status.color}`}>
                    {status.label}
                  </span>
                </div>
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {order.items.length > 2 && (
                      <p className="text-xs text-brand-beige">+{order.items.length - 2} produk lainnya</p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center pt-3 border-t border-brand-beige/20">
                  ...
                  <span className="font-bold text-brand-gold">{formatPrice(Number(order.total))}</span>
                </div>
              </Link>
            );
          })}
